...
please visit http://wnsparsesolve.sourceforge.net.
Note that if you have installed wn_matrix, wn_sparse_solve, and SPARSKIT2
according to the download tutorials at http://wnsparsesolve.sourceforge.net,
...
wish to compile.  Or you can run make all.
See http://wnsparsesolve.sourceforge.net for more
