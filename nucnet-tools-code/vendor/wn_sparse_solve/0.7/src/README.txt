...
//
//   <license>
//      Copyright (c) 2006-2016 Clemson University.
//
...
http://wnsparsesolve.sourceforge.net for downloading information.
wn_sparse_solve routines also require SPARSKIT2.  To download, see
