...
//       xml file without building a tree, print out the data about the species,
...
main( int argc, char **argv ) {
  ...
  if( argc == 2 ) {
    p_my_nuclei = Libnucnet__Nuc__new_from_xml_text_reader( argv[1], NULL );
  } else {
    p_my_nuclei = Libnucnet__Nuc__new_from_xml_text_reader( argv[1], argv[2] );
  }
