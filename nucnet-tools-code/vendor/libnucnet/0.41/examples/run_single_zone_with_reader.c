...
//       Read input without building a tree.
//     </abstract>
//   </description>
// </file>
//////////////////////////////////////////////////////////////////////////////*/
...
int main( int argc, char * argv[] ) {
  ...
  if( argc == 10 ) {
    p_my_nucnet =
      Libnucnet__new_from_xml_text_reader( argv[1], NULL, NULL, NULL );
  } else if( argc == 11 ) {
    p_my_nucnet =
      Libnucnet__new_from_xml_text_reader( argv[1], argv[10], NULL, NULL );
  } else {
    p_my_nucnet =
      Libnucnet__new_from_xml_text_reader( argv[1], argv[10], argv[11], NULL );
  }
