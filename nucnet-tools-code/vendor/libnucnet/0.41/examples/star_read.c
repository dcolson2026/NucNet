...
int main( int argc, char **argv )
{
  ...
  if ( argc != 5 ) {
      fprintf(
        stderr,
        "\nUsage: %s nuc_filename filename indent new_xml_filename\n\n",
        argv[0]
      );
      fprintf(
      ...
      fprintf(
        stderr, "  indent = indent (1) or not (0) the xml output.\n\n"
      );
      fprintf(
  ...
  /*============================================================================
  // Write xml file.  Use the text writer.
  //==========================================================================*/

  Libnucnet__writeZoneDataToXmlFileWithTextWriter(
    p_nucnet, argv[4], atoi( argv[3] )
  );
