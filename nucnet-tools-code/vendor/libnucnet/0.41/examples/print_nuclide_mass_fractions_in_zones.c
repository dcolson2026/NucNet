...
int print_zone_mass_fraction( Libnucnet__Zone *, Libnucnet__Species * );
...
int main( int argc, char * argv[] ) {
  ...
  Libnucnet__iterateZones(
    p_my_nucnet,
    (Libnucnet__Zone__iterateFunction) print_zone_mass_fraction,
    p_species
  ); 
...
)
{
  ...
  fprintf(
    ...
    Libnucnet__Zone__getSpeciesMassFraction( p_zone, p_species )
  ); 
