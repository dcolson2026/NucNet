...
int main( int argc, char * argv[] ) {
  ...
  //==========================================================================*/
   ...
   if ( argc < 5 || argc > 6 ) {
      fprintf(
        stderr,
        "\nUsage: %s reac_xml new_reac_xml updated_xml indent xpath_old xpath_new\n\n", argv[0]
      );
      fprintf(
      ...
      fprintf(
        stderr, "  indent = indent output xml (1) or not (0)\n\n"
      );
      fprintf(
  ...
  if( argc < 7 )
    ...
    Libnucnet__Reac__updateFromXml( p_my_reactions, argv[2], argv[6] );

  /*============================================================================
  // Output to xml.  Use the text writer for output.
  //==========================================================================*/

  Libnucnet__Reac__writeToXmlFileWithTextWriter(
    p_my_reactions, argv[4], atoi( argv[3] )
  );
