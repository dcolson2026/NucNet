...
//       input xml file with the xml text reader, print out those reactions
//       and the total number of reactions, and clear the structure and free
...
int main( int argc, char * argv[] ) {
  ...
  if( argc == 2 ) {
    p_my_reactions =
      Libnucnet__Reac__new_from_xml_text_reader( argv[1], NULL );
  } else {
    p_my_reactions =
      Libnucnet__Reac__new_from_xml_text_reader( argv[1], argv[2] );
  }
