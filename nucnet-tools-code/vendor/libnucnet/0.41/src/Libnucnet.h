...
#define NET_XSD_VERSION "2019-01-15"
...
typedef void ( *Libnucnet__Zone__screeningFunction ) (
  Libnucnet__Zone *,
  Libnucnet__Reaction *,
  double,
  double,
...
/*##############################################################################
// <routine name="Libnucnet__new_from_xml_text_reader()">
//
//   <description>
//     <abstract>
//       Reads in nuclear and reaction data from xml file and stores the
//       reactions in a Libnucnet structure without building a tree.
//       The reactions to be stored may be selected
//       with an xpath expression.  The routine also checks that all reactants
//       and products in a reaction are included in the network and flags that
//       reaction if not.  For this routine, xpath expressions are relative
//       to individual nuclides, reactions, or zones.
//     </abstract>
//     <keywords>
//       Libnucnet, nuclear network, xpath, xml, reactions
//     </keywords>
...
/*##############################################################################
// <routine name="Libnucnet__Net__updateFromXmlTextReader()">
//
//   <description>
//     <abstract>
//       Reads in nuclear and reaction data from xml file and updates the
//       data in the input Libnucnet__Net structure without building a tree.
//       The nuclides and reactions to be stored may be selected
//       with an xpath expression.  In this routine, 
//       xpath expressions are relative to individual nuclides and reactions. 
//     </abstract>
//     <keywords>
//       Libnucnet, nuclear network, xpath, xml, reactions
//     </keywords>
...
//
//     <doc kind="pre" id="s_in_nuc">
//       If all nuclides are required, this string should be empty or ".".
//     </doc>
//     <doc kind="pre" id="s_in_reac">
//       If all reactions are required, this string should be empty or ".".
//     </doc>
//     <doc kind="post" id="result">
//       If the input is valid, routine updates data in the structure
//       with that contained in the input file.
...
void Libnucnet__Net__updateFromXmlTextReader(
  Libnucnet__Net *, const char *, const char *, const char *
);
...
/*##############################################################################
// <routine name="Libnucnet__Zone__updateSpeciesMassFraction()">
//
//   <description>
//     <abstract>
//       Assigns the new species mass fraction to the Libnucnet__Zone struct.
//     </abstract>
//     <keywords>
//       nuclear network, abundance, Y, zone, mass, fraction
//     </keywords>
//   </description>
//
//   <usage>
...
//     <param name="self" kind="in,positional,required" doc="zone" />
//     <param name="p_species" kind="in,positional,required" doc="p_species" />
//     <param name="d_x" kind="in,positional,required" doc="x" />
//
//     <doc kind="pre" id="zone">
//       A pointer to a Libnucnet__Zone structure.
//     </doc>
...
//     </doc>
//     <doc kind="pre" id="x">
//       d_x is a double containing the new mass fraction.
//     </doc>
//
//     <param
//       kind="return"
...
//
//     <doc kind="post" id="result">
//       On successful return, the mass fraction of the species in the zone
//       is modified by the value in d_x.
//     </doc>
//
//     <doc kind="bug" >
//     </doc>
...
//     <doc kind="example" id="example">
//       <synopsis>
//       Update the mass fraction of species p_species for p_zone with d_x:
//       </synopsis>
//       <code>
// Libnucnet__Zone__updateSpeciesMassFraction(
//   p_zone,
...
void Libnucnet__Zone__updateSpeciesMassFraction(
  Libnucnet__Zone *, Libnucnet__Species *, double
);
...
/*##############################################################################
// <routine name="Libnucnet__Zone__getSpeciesMassFraction()">
//
//   <description>
//     <abstract>
//       Retrieves the specified species mass fraction.
//     </abstract>
//     <keywords>
//       nuclear, data, abundance, zone, species, hash, mass, fraction
//     </keywords>
//   </description>
//
//   <usage>
...
//       kind="in,positional,required"
//     >
//       A pointer to the species whose mass fraction is to be retrieved.
//     </param>
//
//     <param
//       kind="return"
...
//
//     <doc kind="post" id="result">
//       Routine returns a double giving the mass fraction of the species
//       in the specified zone.
//       If any input is invalid, Libnucnet error handling is invoked.
//     </doc>
//
...
//     <doc kind="example" id="example">
//       <synopsis>
//       Retrieve he4 mass fraction in zone p_zone from the network p_my_nucnet
//       and store in d_x:
//       </synopsis>
//
//       <code>
...
double Libnucnet__Zone__getSpeciesMassFraction(
  const Libnucnet__Zone *,
  const Libnucnet__Species *
);
...
/*##############################################################################
// <routine name="Libnucnet__assignZoneDataFromXmlTextReader()">
//
//   <description>
//     <abstract>
//       Reads in zone data from an XML file, creates
//       zones, and stores the data in a Libnucnet structure without
//       building a tree.
//     </abstract>
//     <keywords>
//       Libnucnet, nuclear network, xpath, xml, reactions
...
/*##############################################################################
// <routine name="Libnucnet__Zone__getMassFractions()">
//
//   <description>
//     <abstract>
//       Routine to return a gsl_vector containing the mass fractions
//       of a given zone.
//     </abstract>
//     <keywords>
//       Libnucnet, zone, abundances, mass, fraction
//     </keywords>
//   </description>
//
//   <usage>
...
//     <calling_sequence>
// gsl_vector *
// Libnucnet__Zone__getMassFractions( const Libnucnet__Zone *self );
//     </calling_sequence>
//
//     <param
//       name="self"
...
//     <doc kind="post" id="result">
//       Routine returns a new gsl_vector containing the current
//       mass fractions in the zone.  The mass fractions are ordered according
//       to their index.  If the input zone is not valid, Libnucnet error
//       handling is invoked.
//     </doc>
//
...
//     <doc kind="example" id="example1">
//       <synopsis>
//         Retrieve from Libnucnet *p_my_zones the mass fractions in the zone
//         with labels "x1", "y1", "z1":
//       </synopsis>
//
//       <code>
...
gsl_vector *
Libnucnet__Zone__getMassFractions( const Libnucnet__Zone * );
...
/*##############################################################################
// <routine name="Libnucnet__Zone__updateMassFractions()">
//
//   <description>
//     <abstract>
//       Routine to update the mass fractions of a given zone from an
//       input gsl_vector.
//     </abstract>
//     <keywords>
//       Libnucnet, zone, abundances, mass, fractions
//     </keywords>
//   </description>
//
//   <usage>
...
//       doc="x"
//     >
//       A pointer to a gsl_vector containing the new mass fractions.
//     </param>
//     <param
//       kind="return"
//       doc="result"
...
//
//     <doc kind="post" id="result">
//       Upon successful return, the mass fractions have been updated to
//       those in the input vector. If the input zone is not valid, or
//       if the number of elements in the input vector is not equal to
//       the number of species in the zone's network, Libnucnet error
//       handling is invoked.
...
//       <synopsis>
//         Update the abundances in Libnucnet__Zone *p_zone with the
//         mass fractions in gsl_vector *p_my_new_mass_fractions:
//       </synopsis>
//
//       <code>
// Libnucnet__Zone__updateMassFractions(
//   p_zone,
//   p_my_new_mass_fractions
// );
//       </code>
//     </doc>
//
...
void
Libnucnet__Zone__updateMassFractions( Libnucnet__Zone *, gsl_vector * );
...
//
//       <code>
// Libnucnet__Zone__clearNetViews( p_my_zone );
//       </code>
//     </doc>
//
//   </usage>
...
/*##############################################################################
// <routine name="Libnucnet__Net__writeToXmlFileWithTextWriter()">
//
//   <description>
//     <abstract>
//       Output a Libnucnet__Net structure to an xml file using the
//       xml text writer.
//     </abstract>
//     <keywords>
//       nuclear, data, write, file, network
...
//       kind="in,positional,required"
//     >
//       A flag to set whether to indent (1) or not (0) the xml output.
//     </param>
//
//     <param
//       kind="return"
...
//     <doc kind="post" id="result">
//       Upon successful return, the contents of the network
//       are written to s_xml_filename.  The routine uses the xml
//       text writer, so it does not build a tree.
//     </doc>
//
//     <doc kind="bug" >
//     </doc>
...
//       <synopsis>
//         Dump the contents of Libnucnet__Net *p_my_network to the
//         xml file my.xml without indentation:
//       </synopsis>
//
//       <code>
// Libnucnet__Net__writeToXmlFileWithTextWriter( p_my_network, "my.xml", 0 );
//       </code>
//     </doc>
//
//   </usage>
...
/*##############################################################################
// <routine name="Libnucnet__writeZoneDataToXmlFileWithTextWriter()">
//
//   <description>
//     <abstract>
//       Dump the current data in all zones to an xml file.  Don't build
//       a tree.
//     </abstract>
//     <keywords>
//       Libnucnet, zone, mass, fractions, abundances, xml
...
//       kind="in,positional,required"
//     >
//       A flag indicating whether to indent (1) or not (0) the xml output.
//     </param>
//     <param
//       kind="return"
//       doc="result"
...
//       currently defined Libnucnet__Zone__compare_function.  If the input
//       structure is not valid, or the xml file cannot be created,
//       error handling is invoked.  The routine does not build a
//       true, so memory overhead is low.
//     </doc>
//
//     <doc kind="bug" >
//     </doc>
...
//       <synopsis>
//         Dump the current zone data in p_my_libnucnet to the file
//         zone_data.xml with indentation.
//       </synopsis>
//
//       <code>
// Libnucnet__writeZoneDataToXmlFileWithTextWriter(
...
/*##############################################################################
// <routine name="Libnucnet__writeToXmlFileWithTextWriter()">
//
//   <description>
//     <abstract>
//       Output a Libnucnet structure to an xml file.  The routine
//       does not build an internal xml tree.
//     </abstract>
//     <keywords>
//       nuclear, data, write, file, network
//     </keywords>
...
//       <synopsis>
//         Dump the contents of Libnucnet *p_my_nucnet to the
//         xml file my.xml with indentation:
//       </synopsis>
//
//       <code>
// Libnucnet__writeToXmlFileWithTextWriter( p_my_nucnet, "my.xml", 1 );
//       </code>
//     </doc>
//
//   </usage>
