...
int Libnucnet__Nuc__assignSpecies( 
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression(
      (const xmlChar *) ATOMIC_NUMBER, p_xpathCtx_nuclide
   );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) MASS_NUMBER, p_xpathCtx_nuclide );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) XPATH_STATE, p_xpathCtx_nuclide );
...
)
{
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) SOURCE, p_xpathCtx_state );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) MASS_EXCESS, p_xpathCtx_state );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) SPIN, p_xpathCtx_state );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) XPATH_T9, p_xpathCtx_state );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) PARTF, p_xpathCtx_state );
  ...
  sx_state = xmlGetProp( p_state, (const xmlChar *) NUC_STATE_ID );
...
/*##############################################################################
// Libnucnet__Species__getStateString().
//############################################################################*/
...
)
{
  ...
  {
    return (const char *) self->sxState;
  }
...
)
{
  ...
  p_root = xmlNewNode( NULL, (const xmlChar *) NUCLEAR_DATA );
...
)
{
  ...
  p_nuclide = xmlNewNode( NULL, (const xmlChar *) NUCLIDE );
  ...
  {
    p_states = xmlNewNode( NULL, (const xmlChar *) NUC_STATES );
...
)
{
  ...
  p_state = xmlNewNode( NULL, (const xmlChar *) NUC_STATE );

  xmlNewProp( p_state, (const xmlChar *) NUC_STATE_ID, self->sxState );
...
)
{
  ...
  if( strlen( Libnucnet__Species__getSource( self ) ) != 0 ) {
    ...
    xmlNewChild(
      ...
      (const xmlChar *) Libnucnet__Species__getSource( self )
    );
  ...
  p_partf = xmlNewChild( p_node, NULL, (const xmlChar *) PARTF_TABLE, NULL );
  ...
  )
  {
    ...
    p_point = xmlNewChild( p_partf, NULL, (const xmlChar *) PARTF_POINT, NULL );
...
)
{
  ...
  xmlNewProp(
    ...
    (const xmlChar *) LIBNUCNET__NUC__SCHEMALOCATION
  );
...
)
{
  ...
  user_data.sxBaseName = sxBaseName;
...
)
{
  ...
  user_data.pList = xmlListCreate( NULL, NULL );
  user_data.pHash = xmlHashCreate( 0 );
  ...
  xmlHashFree( user_data.pHash, NULL );
...
)
{
  ...
  p_species_array = user_data.pSpeciesArray;
...
)
{
  ...
  if( !s_nuc_xpath || strcmp( s_nuc_xpath, "" ) == 0 )
  {
    Libnucnet__Nuc__iterateSpecies(
      self,
      (Libnucnet__Species__iterateFunction) Libnucnet__Species__addToView,
      p_view
    );
  }
  else
...
)
{
  ...
  for( i = 0; i < p_xpathObj->nodesetval->nodeNr; i++ ) {
    ...
    if( Libnucnet__Nuc__addSpeciesToViewFromNode(
          self,
...
/*##############################################################################
// Libnucnet__Nuc__addSpeciesToViewFromNode().
//############################################################################*/
...
)
{
  ...
  i_result = (unsigned int) work.iMax;
...
/*##############################################################################
// Libnucnet__Nuc__new_from_xml_text_reader().
//############################################################################*/

Libnucnet__Nuc *Libnucnet__Nuc__new_from_xml_text_reader( 
...
)
{
  ...
  Libnucnet__Nuc__updateFromXmlTextReader( self, s_xml_filename, s_xpath );
...
)
{
  ...
  if( !p_reader )
  {
    LIBNUCNET__NUC__ERROR( "Unable to open file." );
  }
  ...
  while( i_ret == 1 )
  {
    Libnucnet__Nuc__processNode( self, p_reader, p_xpathCtx, s_xpath );
    i_ret = xmlTextReaderRead( p_reader );
  }

  if( i_ret != 0 )
  {
    LIBNUCNET__NUC__ERROR( "Failed to parse" );
  }
...
)
{
  ...
  xmlNodePtr p_species_node;
  xmlXPathObjectPtr p_xpathObj_species;

  sx_name = xmlTextReaderConstName( p_reader );

  if( !sx_name )
  {
    LIBNUCNET__NUC__ERROR( "Invalid node" );
  }
  ...
  if( xmlStrEqual( sx_name, (const xmlChar *) NUCLIDE ) )
  {
    p_species_node = xmlTextReaderExpand( p_reader );

    /*==========================================================================
    // Check that proper node (not under zone data).
    //========================================================================*/

    if(
      !xmlStrEqual(
	p_species_node->parent->name,
	(const xmlChar *) NUCLEAR_DATA
      )
    ) { return; }
    ...
    if( s_xpath )
    {
      ...
      if( !p_xpathObj_species )
      {
        LIBNUCNET__NUC__ERROR( "Invalid XPath" );
      }

      if( xmlXPathNodeSetIsEmpty( p_xpathObj_species->nodesetval ) )
      {
        xmlXPathFreeObject( p_xpathObj_species );
        return;
      }
      else
      {
    ...
    Libnucnet__Nuc__assignSpecies( self, p_species_node );
...
)
{
  ...
  if( !p_writer )
  {
    LIBNUCNET__NUC__ERROR( "Couldn't create text writer" );
  }
  ...
  {
    LIBNUCNET__NUC__ERROR( "Couldn't create output file" );
  }

  Libnucnet__Nuc__writeNuclearDataToXml( self, p_writer );
...
)
{
  ...
  if(
    xmlTextWriterStartElement( p_writer, (const xmlChar *)  NUCLEAR_DATA ) < 0
  )
  {
    LIBNUCNET__NUC__ERROR( "Couldn't crreate element" );
  }
  ...
  Libnucnet__Nuc__iterateSpecies(
    self,
    (Libnucnet__Species__iterateFunction) Libnucnet__Species__writeXml,
    &work
  );

  if( xmlTextWriterEndElement( p_writer ) < 0 )
  {
    LIBNUCNET__NUC__ERROR( "Couldn't end element" );
  }

}

/*##############################################################################
// Libnucnet__Species__writeXml().
//############################################################################*/
...
)
{
  ...
  if( xmlTextWriterWriteComment( p_work->pWriter, self->sxBaseName ) < 0 )
  {
    LIBNUCNET__NUC__ERROR( "Couldn't create comment" );
  }
  ...
  if(
    xmlTextWriterStartElement( p_work->pWriter, (const xmlChar *)  NUCLIDE ) < 0
  )
  {
    LIBNUCNET__NUC__ERROR( "Couldn't create element" );
  }
  ...
  if( xmlListSize( p_list ) != 1 )
  {
    if(
      xmlTextWriterStartElement(
        p_work->pWriter, (const xmlChar *)  NUC_STATES
      ) < 0
    )
    {
      LIBNUCNET__NUC__ERROR( "Couldn't create element" );
  ...
  xmlListWalk(
    p_list,
    (xmlListWalker) Libnucnet__Species__writeStateXml,
    p_work->pWriter
  );
...
/*##############################################################################
// Libnucnet__Species__writeStateXml().
//############################################################################*/
...
)
{
  ...
  if( self->sxState )
  {
    ...
    if(
      xmlTextWriterStartElement( p_writer, (const xmlChar *) NUC_STATE ) < 0
    )
    {
      LIBNUCNET__NUC__ERROR( "Couldn't create element" );
    }
  ...
  if(
    xmlTextWriterWriteFormatElement(
      ...
      (const xmlChar *) SOURCE, 
      "%s",
      Libnucnet__Species__getSource( self )
    ) < 0
  )
  {
    LIBNUCNET__NUC__ERROR( "Couldn't create element" );
  ...
  /*============================================================================
  // Create the partition function table.
  //==========================================================================*/

  if(
    xmlTextWriterStartElement(
      p_writer, (const xmlChar *)  PARTF_TABLE
    ) < 0
  )
  {
    LIBNUCNET__NUC__ERROR( "Couldn't create element" );
  ...
  if( self->pT9 && self->pLog10Partf )
  {

    for( i = 0; i < WnMatrix__get_gsl_vector_size( self->pT9 ); i++ )
    {

      if(
        xmlTextWriterStartElement(
          p_writer, (const xmlChar *)  PARTF_POINT
        ) < 0
      )
      {
        LIBNUCNET__NUC__ERROR( "Couldn't create element" );
  ...
  /*============================================================================
  // Done with partition function table.
  //==========================================================================*/
