...
#define NUC_XSD_VERSION "2019-01-15"
...
/*##############################################################################
// <routine name="Libnucnet__Species__getStateString()">
//
//   <description>
//     <abstract>
//       Retrieves the state for a species in the collection of nuclear species.
//     </abstract>
//     <keywords>
//       nuclear, data, species, state
//     </keywords>
//   </description>
//
//   <usage>
...
//     <calling_sequence>
// const char *
// Libnucnet__Species__getStateString( const Libnucnet__Species *self );
//     </calling_sequence>
//
//     <param
//       name="self"
...
//
//     <doc kind="post" id="result">
//       Routine returns a string containing the state for the
//       requested species.  If the species has no state string (for example,
//       the species has only one state), the routine returns NULL.
//       If the species is not valid, Libnucnet__Nuc error handling is invoked.
//     </doc>
//
//     <doc kind="bug" >
//     </doc>
...
//     <doc kind="example" id="example">
//       <synopsis>
//       Print the state of the Libnucnet__Species *p_species:
//       </synopsis>
//
//       <code>
...
const char *
Libnucnet__Species__getStateString( const Libnucnet__Species * );
...
/*##############################################################################
// <routine name="Libnucnet__Nuc__getSpeciesCompareFunction()">
//
//   <description>
//     <abstract>
//       Retrieve the currently set function to be applied during a
//       species sort.
//     </abstract>
//     <keywords>
//       Libnucnet, nuclear, xml, sort
...
//
//     <doc kind="post" id="result">
//       Routine returns the currently set data the data compare function
//       for species in the nuclide collection.  If any input is invalid,
//       error handling is invoked.
//     </doc>
//
//     <doc kind="bug" >
...
//     <doc kind="example" id="example1">
//       <synopsis>
//         Set the species compare function in p_my_new_nuclei to that in
//         p_my_old_nuclei:
//       </synopsis>
//
//       <code>
// Libnucnet__Nuc__setSpeciesCompareFunction(
//   p_my_new_nuclei,
//   Libnucnet__Nuc__getSpeciesCompareFunction( p_my_old_nuclei )
// );
//       </code>
//     </doc>
//
...
/*##############################################################################
// <routine name="Libnucnet__Nuc__new_from_xml_text_reader()">
//
//   <description>
//     <abstract>
//       Reads in nuclear network nuclear data from xml file and stores the
//       species in a structure. This routine does not build a tree, so
//       the memory overhead is greatly reduced.  The species to be stored
//       are selected with an xpath expression, but unlike the routine
//       that builds with a tree, the xpath expression is relative to the
//       individual species.
//     </abstract>
//     <keywords>
//       Libnucnet, nuclear network, xml, xpath, nuclide, species
//     </keywords>
//   </description>
//
//   <usage>
...
//       kind="in,positional,required" 
//     >
//       A string giving the name of the xml file contain the nuclide data.
//       This may be the name of a local file or a URL.
//     </param>
//     <param
//       name="s_xpath"
...
//       doc="s_in"
//     >
//       A string giving the xpath expression for the species desired.
//     </param>
//     <param
//       kind="return"
//       doc="result"
...
//       If all species are required, this string should be "." or NULL.
//     </doc>
//     <doc kind="post" id="result">
//       If the input is valid, routine returns a pointer to a Libnucnet
//       species structure containing species selected by the xpath
//       expression. If no species were found, p_species_list is empty.
//       If the input file or xpath expression(s) is invalid,
//       Libnucnet__Nuc error handling is invoked.
//     </doc>
//
//     <doc kind="bug" >
...
//     <doc kind="example" id="example1">
//       <synopsis>
//       Store all the species from "nuclides.xml"
//       to p_species_list:
//       </synopsis>
//
//       <code>
...
//     <doc kind="example" id="example2">
//       <synopsis>
//       Store the species from "nuclides.xml" with z &lt; 20 and a &lt 100
//       in p_species_list:
//       </synopsis>
//
//       <code>
...
//   Libnucnet__Nuc__new_from_xml(
//     "nuclides.xml",
//     ".//z[. < 20 and (preceding-sibling::a[. < 100] or following-sibling::a[. < 100])]"
//   );
//       </code>
//     </doc>
//
...
/*##############################################################################
// <routine name="Libnucnet__Nuc__updateFromXmlTextReader()">
//
//   <description>
//     <abstract>
//       Updates nuclear network nuclide data in a Libnucnet__Nuc structure
//       from and xml file.  This routine does not build a tree,
//       so the memory overhead is greatly reduced.  The species to be stored
//       are selected with an xpath expression, but unlike the routine
//       that builds with a tree, the xpath expression is relative to the
//       individual species.
//     </abstract>
...
//       kind="in,positional,required" 
//     >
//       A pointer to the pre-existing Libnucnet__Nuc structure to be updated.
//     </param>
//     <param
//       name="s_xml_filename" 
//       kind="in,positional,required" 
//     >
//       A string giving the name of the xml file contain the new species data.
//       This may be the name of a local file or a URL.
//     </param>
//     <param
//       name="s_xpath"
...
//       doc="s_in"
//     >
//       A string giving the xpath expression for desired species.
//     </param>
//     <param
//       kind="return"
//       doc="result"
...
//
//     <doc kind="pre" id="s_in">
//       If all species are required, this should be "." or NULL.
//     </doc>
//     <doc kind="post" id="result">
//       If the input is valid, the input Libnucnet__Nuc structure is
//       updated with the species data from the input file.
//     </doc>
//
//     <doc kind="bug" >
//     </doc>
...
//     <doc kind="example" id="example1">
//       <synopsis>
//       Update the species data in p_my_species, with data from the file
//       "nuclides_new.xml"
//       </synopsis>
//
//       <code>
...
/*##############################################################################
// <routine name="Libnucnet__Nuc__writeToXmlFileWithTextWriter()">
//
//   <description>
//     <abstract>
//       Output a Libnucnet__Nuc structure to an xml file.  Use the text
//       writer which can save on memory usage.
//     </abstract>
//     <keywords>
//       nuclear, data, write, file
//     </keywords>
...
//       kind="in,positional,required"
//     >
//       Flag indicating whether output xml should be indented (1) or not (0).
//     </param>
//
//     <param
//       kind="return"
...
//       <synopsis>
//         Dump the contents of Libnucnet__Nuc *p_my_nuclei to the
//         xml file my.xml and indent the output:
//       </synopsis>
//
//       <code>
// Libnucnet__Nuc__writeToXmlFileWithTextWriter( p_my_nuclei, "my.xml", 1 );
//       </code>
//     </doc>
//
//   </usage>
