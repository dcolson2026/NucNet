...
/*##############################################################################
// Libnucnet__Reac__new_from_xml_text_reader().
//############################################################################*/

Libnucnet__Reac *Libnucnet__Reac__new_from_xml_text_reader( 
...
)
{
  ...
  /*============================================================================
  // Update data from xml text reader.
  //==========================================================================*/

  Libnucnet__Reac__updateFromXmlTextReader( self, s_xml_filename, s_xpath );
...
)
{
  ...
  while( i_ret == 1 )
  {
    Libnucnet__Reac__processNode( self, p_reader, p_xpathCtx, s_xpath );
    i_ret = xmlTextReaderRead( p_reader );
  }

  if( i_ret != 0 )
  {
    LIBNUCNET__REAC__ERROR( "Failed to parse" );
  }
...
)
{
  ...
  xmlNodePtr p_reaction_node;
  xmlXPathObjectPtr p_xpathObj_reaction;

  sx_name = xmlTextReaderConstName( p_reader );

  if( !sx_name )
  {
    LIBNUCNET__REAC__ERROR( "Invalid node" );
  }
  ...
  if( xmlStrEqual( sx_name, (const xmlChar *) REACTION ) )
  {
    p_reaction_node = xmlTextReaderExpand( p_reader );
    ...
    if( s_xpath )
    {
      ...
      if( !p_xpathObj_reaction )
      {
        LIBNUCNET__REAC__ERROR( "Invalid XPath" );
      }

      if( xmlXPathNodeSetIsEmpty( p_xpathObj_reaction->nodesetval ) )
      {
        xmlXPathFreeObject( p_xpathObj_reaction );
        return;
      }
      else
      {
    ...
    Libnucnet__Reac__assignReaction( self, p_reaction_node );
...
)
{
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression(
      (const xmlChar *) REACTION_SOURCE, p_xpathCtx_reaction
    );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) REACTANT, p_xpathCtx_reaction );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) PRODUCT, p_xpathCtx_reaction );
...
Libnucnet__Reaction__addRateDataFromXml(
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression(
      (const xmlChar *) RATE_TABLE_STRING, p_xpathCtx_reaction );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression(
      (const xmlChar *) NON_SMOKER_STRING, p_xpathCtx_reaction );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression(
      (const xmlChar *) SINGLE_RATE_STRING, p_xpathCtx_reaction );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression(
      (const xmlChar *) USER_RATE_STRING, p_xpathCtx_reaction
    );
...
)
{
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression(
      (const xmlChar *) RATE_TABLE_T9, p_xpathCtx_table
    );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression(
      (const xmlChar *) RATE_TABLE_ENTRY, p_xpathCtx_table
    );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression(
      (const xmlChar *) RATE_TABLE_SEF, p_xpathCtx_table
    );
...
)
{
  ...
  xmlXPathObjectPtr p_xpathObj_data;
  xmlChar *sx_str, *sx_name, *sx_tag1, *sx_tag2, *sx_value;
  int i;
  ...
  sx_str = xmlGetProp( p_user_rate, (const xmlChar *) FUNCTION_KEY );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression(
      (const xmlChar *) USER_RATE_PROPERTY_XPATH, p_xpathCtx_user_rate
    );
...
)
{
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) FIT, p_xpathCtx_nsfs );
...
)
{
  ...
  sx_note =
    xmlGetProp( p_non_smoker_fit, (const xmlChar *) NOTE );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) SPINT, p_xpathCtx_nsf );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) SPINF, p_xpathCtx_nsf );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) TLOWHF, p_xpathCtx_nsf );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) TLOWFIT, p_xpathCtx_nsf );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) THIGHFIT, p_xpathCtx_nsf );
  ...
  p_xpathObj_data =
    xmlXPathEvalExpression( (const xmlChar *) ACC, p_xpathCtx_nsf );
...
)
{
  ...
  )
  {
    ...
    xmlHashFree(
      self->pRd->pRateFunctionPropertyHash,
      (xmlHashDeallocator) Libnucnet__Reac__hash_data_xmlFree
    );
...
Libnucnet__Reac__free( Libnucnet__Reac *self ) {
  ...
  if( self->iOwner )
  {
    ...
    if( self->pFDHash )
    {
      xmlHashFree(
        self->pFDHash,
        (xmlHashDeallocator) Libnucnet__Reac__hash_data_free
      );
    }
...
Libnucnet__Reaction__copy( const Libnucnet__Reaction *self )
{
  ...
  else
  {
    p_reaction->pRd->pRateFunctionPropertyHash =
      xmlHashCopy(
        self->pRd->pRateFunctionPropertyHash,
        (xmlHashCopier) Libnucnet__Reac__xml_string_copier
      );
    return p_reaction;
  }
...
)
{
  ...
  sx_str = xmlCharStrdup( "0" );
  if(
     xmlHashSize( p_nsf_user_data->pHash ) == 1 && 
     xmlStrcmp( sx_note, sx_str ) == 0
  )
  {
...
)
{
  ...
  for( i = 1; i <= I_NSF; i++ ) { 
    ...
    xmlStrPrintf( sx_str, REAC_BUF_SIZE, (const WnReacChar *) "a%d", i );
...
)
{
  ...
  xmlNewProp(
    xmlDocGetRootElement( p_doc ),
    (const xmlChar *) XSI_SCHEMA_LOCATION,
    (const xmlChar *) LIBNUCNET__REAC__SCHEMALOCATION
  );
  ...
  )
  {
    ...
    p_rate_node =
      xmlNewChild(
        p_reaction_node,
        NULL,
        (const xmlChar *) SINGLE_RATE_STRING,
        sx_str
      );
  ...
  )
  {
    ...
    p_rate_node =
      xmlNewChild(
        p_reaction_node,
        NULL,
        (const xmlChar *) RATE_TABLE_STRING,
        NULL
      );
    ...
    for( i = 0; i < self->pRd->pRt->pT9->size; i++ ) {
      ...
      xmlNewChild(
         p_point,
         NULL,
         (const xmlChar *) RATE_TABLE_T9_NODE,
         sx_str
      );
      ...
      xmlNewChild(
         p_point,
         NULL,
         (const xmlChar *) RATE_TABLE_ENTRY_NODE,
         sx_str
      );
      ...
      xmlNewChild(
        p_point,
        NULL,
        (const xmlChar *) RATE_TABLE_SEF_NODE,
        sx_str
      );
  ...
  )
  {
    ...
    p_rate_node =
      xmlNewChild(
        p_reaction_node,
        NULL,
        (const xmlChar *) NON_SMOKER_STRING,
        NULL
      );
  ...
  else
  {
    ...
    p_rate_node =
      xmlNewChild(
        p_reaction_node,
        NULL,
        (const xmlChar *) USER_RATE_STRING,
        NULL
      );

    xmlNewProp(
       p_rate_node,
       (const xmlChar *) FUNCTION_KEY,
       self->sxFunctionKey
    );
...
)
{
  ...
  p_property_node =
    xmlNewChild(
      p_node,
      NULL,
      (const xmlChar *) USER_RATE_PROPERTY,
      p_property->sxValue
    );
...
)
{
  ...
  if( !s_reac_xpath || strcmp( s_reac_xpath, "" ) == 0 )
  {
    Libnucnet__Reac__iterateReactions(
      self,
      (Libnucnet__Reaction__iterateFunction) Libnucnet__Reaction__addToView,
      p_view
    );
  }
  else
...
/*##############################################################################
// Libnucnet__Reaction__addToView().
//############################################################################*/
...
/*##############################################################################
// Libnucnet__Reac__hash_data_free()
//############################################################################*/

void Libnucnet__Reac__hash_data_free(
  void * p_data, xmlChar * sx_name
)
{
  if( !sx_name ) {
    LIBNUCNET__REAC__ERROR( "Invalid hash entry." );
  }
  free( p_data );
}

/*##############################################################################
// Libnucnet__Reac__hash_data_xmlFree()
//############################################################################*/

void Libnucnet__Reac__hash_data_xmlFree(
  void * p_data, xmlChar * sx_name
)
{
  if( !sx_name ) {
...
/*##############################################################################
// Libnucnet__Reac__xml_string_copier()
//############################################################################*/

xmlChar * Libnucnet__Reac__xml_string_copier(
  xmlChar * sx_old,
  xmlChar * sx_name
)
{
...
)
{
  ...
  if( !p_writer )
  {
    LIBNUCNET__REAC__ERROR( "Couldn't create text writer" );
  }
  ...
  {
    LIBNUCNET__REAC__ERROR( "Couldn't create output file" );
  }

  Libnucnet__Reac__writeReactionDataToXml( self, p_writer );
...
)
{
  ...
  struct
  {
    const Libnucnet__Reac * pReac;
    xmlTextWriterPtr pWriter;
  } work;

  if(
    xmlTextWriterStartElement( p_writer, (const xmlChar *)  REACTION_DATA ) < 0
  )
  {
    LIBNUCNET__REAC__ERROR( "Couldn't crreate element" );
  }

  work.pReac = self;
  work.pWriter = p_writer;

  Libnucnet__Reac__iterateReactions(
    self,
    (Libnucnet__Reaction__iterateFunction) Libnucnet__Reaction__writeXml,
    &work
  );

  if( xmlTextWriterEndElement( p_writer ) < 0 )
  {
    LIBNUCNET__REAC__ERROR( "Couldn't end element" );
  }

}

/*##############################################################################
// Libnucnet__Reaction__writeXml().
//############################################################################*/
...
)
{
  ...
  if( xmlTextWriterWriteComment( p_work->pWriter, self->sxReaction ) < 0 )
  {
    LIBNUCNET__REAC__ERROR( "Couldn't create comment" );
  }
  ...
  if(
    xmlTextWriterStartElement(
      p_work->pWriter, (const xmlChar *)  REACTION
    ) < 0
  )
  {
    LIBNUCNET__REAC__ERROR( "Couldn't create element" );
  }
  ...
  work_element.pWriter = p_work->pWriter;
  work_element.sxElement = xmlCharStrdup( REACTANT );

  xmlListWalk(
    self->pReactantList,
    (xmlListWalker) Libnucnet__Reaction__Element__writeXml,
    &work_element
  );
  ...
  xmlFree( work_element.sxElement );

  work_element.sxElement = xmlCharStrdup( PRODUCT );
  ...
  if(
    xmlStrcmp( self->sxFunctionKey, (const xmlChar *) SINGLE_RATE_STRING ) == 0
  )
  {
    Libnucnet__Reaction__writeSingleRateXml( self, p_work->pWriter );
  }
  else if(
    xmlStrcmp( self->sxFunctionKey, (const xmlChar *) RATE_TABLE_STRING ) == 0
  )
  {
    Libnucnet__Reaction__writeRateTableXml( self, p_work->pWriter );
  }
  else if(
    xmlStrcmp( self->sxFunctionKey, (const xmlChar *) NON_SMOKER_STRING ) == 0
  )
  {
    Libnucnet__Reaction__writeNonSmokerXml( self, p_work->pWriter );
  }
  else
  {
    Libnucnet__Reaction__writeUserRateXml( self, p_work->pWriter );
  }
  ...
  if( xmlTextWriterEndElement( p_work->pWriter ) < 0 )
  {
    LIBNUCNET__REAC__ERROR( "Couldn't end element" );
  }
...
/*##############################################################################
// Libnucnet__Reaction__Element__writeXml().
//############################################################################*/
...
)
{
  ...
  work_element * p_work = (work_element *) p_data;
  ...
  if(
    xmlTextWriterWriteFormatElement(
      ...
      p_work->sxElement,
      "%s",
      Libnucnet__Reaction__Element__getName( self )
    ) < 0
  )
  {
    LIBNUCNET__REAC__ERROR( "Couldn't create element" );
...
/*##############################################################################
// Libnucnet__Reaction__writeSingleRateXml().
//############################################################################*/
...
/*##############################################################################
// Libnucnet__Reaction__writeRateTableXml().
//############################################################################*/
...
)
{
  ...
  if(
    xmlTextWriterStartElement(
      p_writer, (const xmlChar *) RATE_TABLE_STRING
    ) < 0
  )
  {
    LIBNUCNET__REAC__ERROR( "Couldn't create element" );
  ...
  for( i = 0; i < self->pRd->pRt->pT9->size; i++ )
  {
    ...
    if(
      xmlTextWriterStartElement( p_writer, (const xmlChar *) REAC_POINT ) < 0
    )
    {
      LIBNUCNET__REAC__ERROR( "Couldn't create element" );
    }
...
/*##############################################################################
// Libnucnet__Reaction__writeUserRateXml().
//############################################################################*/
...
)
{
  ...
  if(
    xmlTextWriterStartElement(
      p_writer, (const xmlChar *) USER_RATE_STRING
    ) < 0
  )
  {
    LIBNUCNET__REAC__ERROR( "Couldn't create element" );
  ...
  {
    LIBNUCNET__REAC__ERROR( "Couldn't create attribute" );
  }
  ...
  if(
    xmlTextWriterStartElement( p_writer, (const xmlChar *) PROPERTIES ) < 0
  )
  {
    LIBNUCNET__REAC__ERROR( "Couldn't create element" );
  }
  ...
  Libnucnet__Reaction__iterateUserRateFunctionProperties(
    ...
    (Libnucnet__Reaction__user_rate_property_iterate_function)
      Libnucnet__Reaction__write_user_rate_property_to_xml,
    p_writer
  );
...
)
{
  ...
  if(
    xmlTextWriterStartElement(
      p_writer, (const xmlChar *) USER_RATE_PROPERTY
    ) < 0
  )
  {
    LIBNUCNET__REAC__ERROR( "Couldn't create element" );
  ...
  if( xmlTextWriterWriteString( p_writer, (const xmlChar *) s_value ) < 0 )
  {
    LIBNUCNET__REAC__ERROR( "Couldn't create content" );
  }
...
/*##############################################################################
// Libnucnet__Reaction__writeNonSmokerXml().
//############################################################################*/
...
)
{
  ...
  if(
    xmlTextWriterStartElement( p_writer, (const xmlChar *) NON_SMOKER_STRING )
    < 0
  )
  {
    LIBNUCNET__REAC__ERROR( "Couldn't start element" );
  }

  work.pWriter = p_writer;
  work.iSize = xmlHashSize( self->pRd->pNsfHash );

  xmlHashScan(
    self->pRd->pNsfHash,
    (xmlHashScanner) Libnucnet__Reaction__writeNonSmokerFitXml,
    &work
  );
...
/*##############################################################################
// Libnucnet__Reaction__writeNonSmokerFitXml().
//############################################################################*/
...
)
{
  ...
  {
    if(
      xmlTextWriterStartElement( p_work->pWriter, (const xmlChar *) FIT ) < 0
    )
    {
      LIBNUCNET__REAC__ERROR( "Couldn't create element" );
    }
    if( sx_note )
    {
      if(
        xmlTextWriterWriteAttribute(
   	  p_work->pWriter, (const xmlChar *) NOTE, sx_note ) < 0
      )
      {
        LIBNUCNET__REAC__ERROR( "Couldn't create element" );
      }
  ...
  if( p_nsf->pSpint )
  {
	...
	*(p_nsf->pSpint)
    ...
    {
      LIBNUCNET__REAC__ERROR( "Couldn't write element" );
    }
  }
  ...
  {
    sx_str = (xmlChar *) malloc( sizeof( xmlChar ) * REAC_BUF_SIZE );
    xmlStrPrintf( sx_str, REAC_BUF_SIZE, (const WnReacChar *) "a%d", i_index );
