...
#define REAC_XSD_VERSION "2019-01-15"
...
/*##############################################################################
// <routine name="Libnucnet__Reac__new_from_xml_text_reader()">
//
//   <description>
//     <abstract>
//       Reads in nuclear network reaction data from xml file and stores the
//       reactions in a structure. This routine does not build a tree, so
//       the memory overhead is greatly reduced.  The reactions to be stored
...
//       doc="s_in"
//     >
//       A string giving the xpath expression for the reactants or products
//       in the reaction(s) desired.
//     </param>
//     <param
//       kind="return"
...
//
//     <doc kind="pre" id="s_in">
//       If all reactions are required, this string should be "." or NULL.
//     </doc>
//     <doc kind="post" id="result">
//       If the input is valid, routine returns a pointer to a Libnucnet
//       reaction structure containing reactions selected by the xpath
...
//       <synopsis>
//       Store the reactions from "reactions.xml" containing 'h1' as a reactant
//       and 'gamma' as a product to p_reactions_list:
//       </synopsis>
//
//       <code>
// p_h1_reactions_list =
...
/*##############################################################################
// <routine name="Libnucnet__Reac__updateFromXmlTextReader()">
//
//   <description>
//     <abstract>
//       Updates nuclear network reaction data in a Libnucnet__Reac structure
//       from and xml file.  This routine. This routine does not build a tree,
//       so the memory overhead is greatly reduced.  The reactions to be stored
//       are selected with an xpath expression, but unlike the routine
//       that builds with a tree, the xpath expression is relative to the
//       individual reaction.
//     </abstract>
...
//     >
//       A string giving the xpath expression for the reactants or products
//       in the reaction in the update file desired.
//     </param>
//     <param
//       kind="return"
//       doc="result"
...
//
//     <doc kind="pre" id="s_in">
//       If all reactions are required, this should be "." or NULL.
//     </doc>
//     <doc kind="post" id="result">
//       If the input is valid, the input Libnucnet__Reac structure is
//       updated with the reaction data from the input file.
...
/*##############################################################################
// <routine name="Libnucnet__Reac__writeToXmlFileWithTextWrter()">
//
//   <description>
//     <abstract>
//       Output a Libnucnet__Reac structure to an xml file.  Routine
//       uses the text writer for output.
//     </abstract>
//     <keywords>
//       nuclear, data, write, file, reaction
//     </keywords>
...
//       kind="in,positional,required"
//     >
//       A flag indicating whether the xml output should be indented (1)
//       or not (0).
//     </param>
//
//     <param
...
//       are written to s_xml_filename.  Reactions are output in the order
//       determined by the currently defined
//       Libnucnet__Reaction__compare_function.  The routine does not
//       build a tree, which saves on memory overhead.
//     </doc>
//
//     <doc kind="bug" >
//     </doc>
...
//       <synopsis>
//         Dump the contents of Libnucnet__Reac *p_my_reactions to the
//         xml file my.xml without indenting:
//       </synopsis>
//
//       <code>
