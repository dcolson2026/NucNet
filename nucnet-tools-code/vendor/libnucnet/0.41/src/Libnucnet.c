...
Libnucnet__new_from_xml_text_reader(
  ...
  Libnucnet__assignZoneDataFromXmlTextReader(
    self, s_xml_filename, s_xpath_zone
  );
...
Libnucnet__assignZoneDataFromXmlDocument(
  ...
  xmlChar *sx_xpath, *sx_xpath_suffix, *sx_str;
  int i;
  ...
  for( i = 0; i < p_xpathObj->nodesetval->nodeNr; i++ ) {
    ...
    Libnucnet__assignZone( self, p_xpathObj->nodesetval->nodeTab[i] );
...
)
{
  ...
  xmlChar * sx_label_1, * sx_label_2, * sx_label_3;

  sx_label_1 = xmlGetProp( p_zone_node, (const xmlChar *) LABEL_1 );
  sx_label_2 = xmlGetProp( p_zone_node, (const xmlChar *) LABEL_2 );
  sx_label_3 = xmlGetProp( p_zone_node, (const xmlChar *) LABEL_3 );
...
Libnucnet__Zone__assignAbundancesFromXml( 
  ...
  xmlXPathObjectPtr p_xpathObj;
  xmlNodePtr p_data;
  xmlChar *sx_z, *sx_a, *sx_m, *sx_prop;
  ...
  p_xpathObj =
    xmlXPathEvalExpression(
      (const xmlChar *) XPATH_ZONE_MASS_FRACTIONS,
      p_xpathCtx
    );
  ...
  for( i = 0; i < p_xpathObj->nodesetval->nodeNr; i++ )
  {
    ...
    Libnucnet__Zone__updateSpeciesMassFraction( self, p_species, d_x );
...
Libnucnet__Zone__assignOptionalPropertiesFromXml( 
  ...
  xmlXPathContextPtr p_xpathCtx;
  xmlXPathObjectPtr p_xpathObj;
  xmlChar *sx_prop_name, *sx_prop_tag1, *sx_prop_tag2, *sx_data;
  int i;
  ...
  p_xpathObj =
    xmlXPathEvalExpression(
      (const xmlChar *) XPATH_OPTIONAL_PROPERTY,
      p_xpathCtx
  );
  ...
  for( i = 0; i < p_xpathObj->nodesetval->nodeNr; i++ )
  {
    ...
    xmlHashUpdateEntry3(
      ...
      sx_prop_tag2,
      sx_data,
      (xmlHashDeallocator) Libnucnet__hash_data_xmlFree
    ); 
...
Libnucnet__Net__updateFromXmlTextReader(
  ...
  Libnucnet__Nuc__updateFromXmlTextReader(
    self->pNuc, s_xml_filename, s_xpath_nuc
  );
  ...
  Libnucnet__Reac__updateFromXmlTextReader(
    self->pReac, s_xml_filename, s_xpath_reac
  );
...
Libnucnet__Net__checkReactionForBaryonConservation(
  ...
  user_data.pNet = self;
  user_data.iBaryonNumberChange = 0;
  ...
  user_data.iBaryonNumberChange *= -1;
  ...
  if( user_data.iBaryonNumberChange ) {
...
Libnucnet__Net__checkReactionForLeptonConservation(
  ...
  user_data.pNet = self;
  user_data.iElectronLeptonNumberChange = 0;
  user_data.iMuLeptonNumberChange = 0;
  user_data.iTauLeptonNumberChange = 0;
  ...
  user_data.iElectronLeptonNumberChange *= -1;
  user_data.iMuLeptonNumberChange *= -1;
  user_data.iTauLeptonNumberChange *= -1;
  ...
  if( user_data.iElectronLeptonNumberChange ) {
    fprintf( stderr, "%s\n", Libnucnet__Reaction__getString( p_reaction ) );
    LIBNUCNET__ERROR( "Electron lepton number not conserved" );
  }

  if( user_data.iMuLeptonNumberChange ) {
    fprintf( stderr, "%s\n", Libnucnet__Reaction__getString( p_reaction ) );
    LIBNUCNET__ERROR( "Muon lepton number not conserved" );
  }

  if( user_data.iTauLeptonNumberChange ) {
    fprintf( stderr, "%s\n", Libnucnet__Reaction__getString( p_reaction ) );
...
)
{
  ...
  extra_data.dT9 = d_t9;
  extra_data.dRho = d_rho;
  extra_data.dYe = Libnucnet__Zone__computeZMoment( self, 1 );

  extra_data.pZone = self;
...
Libnucnet__Zone__computeRatesCallback(
  ...
  extra_data * p_my_data = ( extra_data * ) p_data;
...
)
{
  ...
  p_my_data->pZone->pfScreeningFunction(
    p_my_data->pZone,
    p_reaction,
    p_my_data->dT9,
    p_my_data->dRho,
...
)
{
  ...
  extra_data.pNet = self;
  extra_data.dCorr = 0.;
  extra_data.dT9 = d_t9;
  extra_data.dRho = d_rho;
  extra_data.dYe = d_ye;
  extra_data.pfFunc = pf_correction_function;
  extra_data.pUserData = p_user_data;
...
Libnucnet__Zone__computeJacobianMatrix( Libnucnet__Zone *self )
{
  ...
  extra_data.pAbunds = Libnucnet__Zone__getAbundances( self );
  ...
  p_matrix = extra_data.pMatrix;

  gsl_vector_free( extra_data.pAbunds );
...
)
{
  ...
  extra_data.pZone = self;
  extra_data.dRegy = d_regy;
  extra_data.dYmin = d_ymin;
  extra_data.dDtnew = ( 1. + d_regt ) * extra_data.dDt;
...
Libnucnet__Zone__updateSpeciesMassFraction(
  ...
  Libnucnet__Zone__updateSpeciesAbundance(
    self,
    p_species,
    d_x / (double) Libnucnet__Species__getA( p_species )
  );
}
...
/*##############################################################################
// Libnucnet__Zone__getSpeciesMassFraction().
//############################################################################*/
...
Libnucnet__Zone__getSpeciesMassFraction(
  ...
  return *p_abund * Libnucnet__Species__getA( p_species );
...
Libnucnet__Zone__free( Libnucnet__Zone *self ) {
  ...
  xmlHashFree(
    self->pViewHash,
    (xmlHashDeallocator) Libnucnet__NetView__free_wrapper
  );
...
)
{
  ...
  size_t i_index;
  unsigned int i_a;
  user_data * p_my_data = ( user_data * ) p_data;
  ...
  gsl_vector_set(
    p_my_data->pVector,
    i_index,
    Libnucnet__Zone__getSpeciesAbundance( p_my_data->pZone, p_species )
      * (double) (1 + p_my_data->iFlag * ( i_a - 1 ) )
  );
...
void
Libnucnet__Zone__updateMassFractions(
  Libnucnet__Zone *self, gsl_vector *p_x
)
{
...
)
{
  ...
  user_data.pVector = p_abundances;
  user_data.pZone = self;
  user_data.iFlag = 0;
...
)
{
  ...
  Libnucnet__Zone__updateSpeciesAbundance(
    ...
    gsl_vector_get( p_user_data->pVector, i )
      / (double) ( 1 + p_user_data->iFlag * ( i_a - 1 ) )
  );
...
)
{
  ...
  user_data.pVector = p_abundance_changes;
  user_data.pZone = self;
...
)
{
  ...
  Libnucnet__Zone__updateSpeciesAbundanceChange(
    p_my_data->pZone,
    p_species,
    gsl_vector_get( p_my_data->pVector, i )
  );
...
)
{
  ...
  xmlNewNs(
    xmlDocGetRootElement( p_doc ),
    (const xmlChar *) W3C__NAMESPACE,
    (const xmlChar *) XSI
  );

  xmlNewProp(
    xmlDocGetRootElement( p_doc ),
    (const xmlChar *) XSI_LOCATION,
    (const xmlChar *) LIBNUCNET__ZONE_DATA__SCHEMALOCATION
  );
...
)
{
  ...
  work.pRoot = xmlDocGetRootElement( p_doc );

  work.sxMassFractionFormat = self->sxMassFractionFormat;
...
Libnucnet__newZoneDataXmlDocument( void )
{
  ...
  p_doc = xmlNewDoc( (const xmlChar *) XML_VERSION );
  ...
  p_root = xmlNewNode( NULL, (const xmlChar *) ZONE_DATA );
...
)
{
  ...
  p_zone_node =
    xmlNewChild( p_work->pRoot, NULL, (const xmlChar *) ZONE, NULL );

  if( strcmp( (char *) self->sxLabel[0], ZERO ) )
  {
    xmlNewProp( p_zone_node, (const xmlChar *) LABEL_1, self->sxLabel[0] );
  }

  if( strcmp( (char *) self->sxLabel[1], ZERO ) )
  {
    xmlNewProp( p_zone_node, (const xmlChar *) LABEL_2, self->sxLabel[1] );
  }

  if( strcmp( (char *) self->sxLabel[2], ZERO ) )
  {
    xmlNewProp( p_zone_node, (const xmlChar *) LABEL_3, self->sxLabel[2] );
  }
  ...
  {
    user_data.pOptionalPropertiesNode =
      xmlNewChild(
        p_zone_node, NULL, (const xmlChar *) OPTIONAL_PROPERTIES, NULL
    );
  ...
  p_mass_fractions_node =
    xmlNewChild( p_zone_node, NULL, (const xmlChar *) MASS_FRACTIONS, NULL );
  ...
  if( !WnMatrix__value_is_zero( d_x ) )
  {
    ...
    p_nuclide =
      xmlNewChild(
        p_mass_fractions_node,
        NULL,
        (const xmlChar *) NUCLIDE,
        NULL
      );

    xmlNewProp( p_nuclide, (const xmlChar *) SPECIES_NAME, p_species->sxName );
    ...
    xmlNewChild( p_nuclide, NULL, (const xmlChar *) ATOMIC_NUMBER, sx_str );
    xmlFree( sx_str );
    ...
    xmlNewChild( p_nuclide, NULL, (const xmlChar *) MASS_NUMBER, sx_str );
    xmlFree( sx_str );
    ...
    xmlNewChild( p_nuclide, NULL, (const xmlChar *) MASS_FRACTION, sx_str );
    xmlFree( sx_str );
...
)
{
  ...
  xmlNewProp( p_node, (const xmlChar *) PROPERTY_NAME, sx_name );

  if( sx_tag1 )
  {
    xmlNewProp( p_node, (const xmlChar *) PROPERTY_TAG1, sx_tag1 );
  }

  if( sx_tag2 )
  {
    xmlNewProp( p_node, (const xmlChar *) PROPERTY_TAG2, sx_tag2 );
  }
...
)
{
  ...
  work_data.pfFunc = pf_func;
  work_data.pUserData = p_user_data;
...
)
{
  ...
  p_root = xmlNewNode( NULL, (const xmlChar *) NUCLEAR_NETWORK );
...
)
{
  ...
  p_root = xmlNewNode( NULL, (const xmlChar *) LIBNUCNET_INPUT );
...
)
{
  ...
  sx_function_key = xmlCharStrdup( s_function_key );
...
)
{
  ...
  work.pZone = self;
  work.sxNucleonType = xmlCharStrdup( s_nucleon_type );
...
)
{
  ...
  work.pNuc = Libnucnet__Net__getNuc( self );
  work.sxString = NULL;
  ...
  work.sxString = xmlStrcat( work.sxString, sx_tmp );
  xmlFree( sx_tmp );
  ...
  s_string =
    (char *)
    malloc( sizeof( char ) * ( (size_t) xmlStrlen( work.sxString ) + 1 ) );

  strcpy( s_string, (const char *) work.sxString );

  xmlFree( work.sxString );
...
)
{
  ...
  if( !sx_name )
  {
    LIBNUCNET__ERROR( "Invalid hash entry." );
  }
  xmlFree( p_data );
...
/*##############################################################################
// Libnucnet__NetView__free_wrapper().
//############################################################################*/
...
)
{
  ...
  p_reader = xmlReaderForFile( s_file_name, NULL, XML_PARSE_XINCLUDE );

  if( !p_reader )
  {
    LIBNUCNET__REAC__ERROR( "Unable to open file." );
  }
  ...
  while( i_ret == 1 )
  {
    Libnucnet__processNode( self, p_reader, p_xpathCtx, s_xpath );
    i_ret = xmlTextReaderRead( p_reader );
  }

  if( i_ret != 0 )
  {
    LIBNUCNET__ERROR( "Failed to parse" );
  }
...
)
{
  ...
  const xmlChar *sx_name;
  xmlNodePtr p_zone_node;
  xmlXPathObjectPtr p_xpathObj_zone;

  sx_name = xmlTextReaderConstName( p_reader );

  if( !sx_name )
  {
    LIBNUCNET__ERROR( "Invalid node" );
  }

  if( xmlTextReaderNodeType( p_reader ) == XML_READER_TYPE_END_ELEMENT )
  {
    return;
  }

  if( xmlStrEqual( sx_name, (const xmlChar *) ZONE ) )
  {
    p_zone_node = xmlTextReaderExpand( p_reader );
    ...
    if( s_xpath )
    {
      ...
      if( !p_xpathObj_zone )
      {
        LIBNUCNET__ERROR( "Invalid XPath" );
      }

      if( xmlXPathNodeSetIsEmpty( p_xpathObj_zone->nodesetval ) )
      {
        xmlXPathFreeObject( p_xpathObj_zone );
        return;
      }
      else
      {
    ...
    Libnucnet__assignZone( self, p_zone_node );
...
/*##############################################################################
// Libnucnet__Net__writeToXmlFileWithTextWriter().
//############################################################################*/
...
)
{
  ...
  assert( i_indent == 0 || i_indent == 1 );

  p_writer = xmlNewTextWriterFilename( s_output_xml_filename, 0 );

  if( !p_writer )
  {
    LIBNUCNET__ERROR( "Couldn't create text writer" );
  }

  xmlTextWriterSetIndent( p_writer, i_indent );

  if( xmlTextWriterStartDocument( p_writer, NULL, NULL, NULL ) < 0 )
  {
    LIBNUCNET__ERROR( "Couldn't create output file" );
  }

  if(
    xmlTextWriterStartElement( p_writer, (const xmlChar *) NUCLEAR_NETWORK ) < 0
  )
  {
    LIBNUCNET__ERROR( "Couldn't create element" );
  }

  Libnucnet__Nuc__writeNuclearDataToXml(
    Libnucnet__Net__getNuc( self ), p_writer
  );

  Libnucnet__Reac__writeReactionDataToXml(
    Libnucnet__Net__getReac( self ), p_writer
  );

  if( xmlTextWriterEndDocument( p_writer ) < 0 )
  {
    LIBNUCNET__ERROR( "Couldn't create output file" );
  }
...
)
{
  ...
  Libnucnet__writeZoneDataXml( self, p_writer );
...
)
{
  ...
  size_t i, i_zones, i_species;
  Libnucnet__Zone ** p_zones;
  Libnucnet__Species ** p_species_array;

  if( xmlTextWriterStartElement( p_writer, (const xmlChar *) ZONE_DATA ) < 0 )
  {
    LIBNUCNET__ERROR( "Couldn't create element" );
  }

  /*============================================================================
  // Iterate zones, if present.
  //==========================================================================*/

  if( Libnucnet__getNumberOfZones( self ) > 0 )
  {

    p_zones = Libnucnet__createZoneArray( self );

    i_zones = Libnucnet__getNumberOfZones( self );

    p_species_array =
      Libnucnet__Nuc__createSpeciesArray(
        Libnucnet__Net__getNuc( Libnucnet__Zone__getNet( p_zones[0] ) )
      );
    ...
    for( i = 0; i < i_zones; i++ )
    {
      if( xmlTextWriterStartElement( p_writer, (const xmlChar *) ZONE ) < 0 )
      {
        LIBNUCNET__ERROR( "Couldn't create element" );
      }

      if( xmlStrcmp( p_zones[i]->sxLabel[0], (const xmlChar *) "0" ) )
      {
        if(
          xmlTextWriterWriteAttribute(
            p_writer, (const xmlChar *) LABEL_1, p_zones[i]->sxLabel[0]
          ) < 0
        )
        {
          LIBNUCNET__ERROR( "Couldn't create attribute" );
        }
      }

      if( xmlStrcmp( p_zones[i]->sxLabel[1], (const xmlChar *) "0" ) )
      {
        if(
          xmlTextWriterWriteAttribute(
            p_writer, (const xmlChar *) LABEL_2, p_zones[i]->sxLabel[1]
          ) < 0
        )
        {
          LIBNUCNET__ERROR( "Couldn't create attribute" );
      ...
      if( xmlStrcmp( p_zones[i]->sxLabel[2], (const xmlChar *) "0" ) )
      {
        if(
          xmlTextWriterWriteAttribute(
            p_writer, (const xmlChar *) LABEL_3, p_zones[i]->sxLabel[2]
          ) < 0
        )
        {
          LIBNUCNET__ERROR( "Couldn't create attribute" );
      ...
      if( xmlHashSize( p_zones[i]->pPropertyHash ) > 0 )
      {
        if(
          xmlTextWriterStartElement(
            p_writer, (const xmlChar *) OPTIONAL_PROPERTIES
          ) < 0
        )
        {
          LIBNUCNET__ERROR( "Couldn't start element" );
        }
        ...
        Libnucnet__Zone__iterateOptionalProperties(
          ...
          NULL,
          (Libnucnet__Zone__optional_property_iterate_function)
            Libnucnet__Zone__write_optional_property_xml,
          p_writer
        );

        if( xmlTextWriterEndElement( p_writer ) < 0 )
        {
          LIBNUCNET__ERROR( "Couldn't end element" );
        }

      }

      Libnucnet__Zone__writeMassFractionsXml(
        p_zones[i],
        p_species_array,
        i_species,
        (const char *) self->sxMassFractionFormat,
        p_writer
      );
...
)
{
  ...
  if( xmlTextWriterStartElement( p_writer, (const xmlChar *) PROPERTY ) < 0 )
  {
    LIBNUCNET__ERROR( "Couldn't start element" );
  }
  ...
  if(
    xmlTextWriterWriteString( p_writer, (const xmlChar *) s_value ) < 0
  ) 
  { 
    LIBNUCNET__ERROR( "Couldn't create element" );
  }
...
)
{
  ...
  size_t i;
  double d_mass_fraction;

  if(
    xmlTextWriterStartElement(
      p_writer,
      (const xmlChar *) MASS_FRACTIONS
    ) < 0
  )
  {
    LIBNUCNET__ERROR( "Couldn't create element" );
  ...
  {
    d_mass_fraction =
      Libnucnet__Zone__getSpeciesMassFraction( self, p_species_array[i] );

    if( d_mass_fraction > 0 )
    {

      if(
        xmlTextWriterStartElement( p_writer, (const xmlChar *) NUCLIDE ) < 0
      )
      {
        LIBNUCNET__ERROR( "Couldn't start element" );
      }
      ...
      if(
        xmlTextWriterWriteAttribute(
          p_writer,
          (const xmlChar *) SPECIES_NAME,
          p_species_array[i]->sxName
        ) < 0
      )
      {
        LIBNUCNET__ERROR( "Couldn't write attribute" );
      }

      if(
        xmlTextWriterWriteFormatElement(
          p_writer,
          (const xmlChar *) ATOMIC_NUMBER,
          "%d",
          Libnucnet__Species__getZ( p_species_array[i] )
        ) < 0
      )
      {
        LIBNUCNET__ERROR( "Couldn't write element" );
      }

      if(
        xmlTextWriterWriteFormatElement(
          p_writer,
          (const xmlChar *) MASS_NUMBER,
          "%d",
          Libnucnet__Species__getA( p_species_array[i] )
        ) < 0
      )
      {
        LIBNUCNET__ERROR( "Couldn't write element" );
...
)
{
  ...
  if(
    xmlTextWriterStartElement( p_writer, (const xmlChar *) LIBNUCNET_INPUT ) < 0
  )
  {
    LIBNUCNET__ERROR( "Couldn't create element" );
  }
  ...
  Libnucnet__Nuc__writeNuclearDataToXml(
    self->pNet->pNuc, p_writer
  );

  Libnucnet__Reac__writeReactionDataToXml(
    self->pNet->pReac, p_writer
  );
