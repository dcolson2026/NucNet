...
)
{
  ...
  } else if( s_neutrino == "anti-neutrino_e" )
  {
    return
      compute_neutrino_rate(
        zone,
  ...
  } else if( s_neutrino == "neutrino_mu" )
  {
    return
      compute_neutrino_rate(
        zone,
  ...
  } else if( s_neutrino == "anti-neutrino_mu" )
  {
    return
      compute_neutrino_rate(
        zone,
  ...
  } else if( s_neutrino == "neutrino_tau" )
  {
    return
      compute_neutrino_rate(
        zone,
  ...
  } else if( s_neutrino == "anti-neutrino_tau" )
  {
    return
      compute_neutrino_rate(
        zone,
