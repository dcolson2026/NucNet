...
compute_entropy_per_nucleon( nnt::Zone& zone )
{
  ...
  return
    compute_thermo_quantity( zone, nnt::s_ENTROPY_PER_NUCLEON, nnt::s_BARYON ) +
    compute_thermo_quantity(
      zone, nnt::s_ENTROPY_PER_NUCLEON, nnt::s_ELECTRON
    ) +
    compute_thermo_quantity( zone, nnt::s_ENTROPY_PER_NUCLEON, nnt::s_PHOTON );
