...
////////////////////////////////////////////////////////////////////////////////
//! \file
//! \brief Example code to print out properties for a given group in the zones.
////////////////////////////////////////////////////////////////////////////////
...
check_input( int argc, char **argv )
{
  ...
  if( argc < 4 )
  {
    ...
    std::cout << "Purpose: " << argv[0] <<
      " prints out selected properties for zones in a given group ";
    std::cout <<
      " from an hdf5 file." << std::endl;
    fprintf(
      stderr,
      "\nUsage: %s hdf5_file group property ...\n\n",
      argv[0]
    );
    fprintf(
      stderr,
    ...
    fprintf(
      stderr,
      "  group = group to extract zone properties from\n\n"
    );
    fprintf(
      stderr,
