...
main( int argc, char **argv )
{
  ...
  bool b_convert = false, b_print_skipped = false;
  ...
  try
  {
    ...
    desc.add_options()
      ...
      (
        "print_skipped",
        "print out data on skipped reactions"
      )
      ;
    ...
    if( vm.count("print_skipped") )
    {
      b_print_skipped = true;
    }
  ...
  //----------------------------------------------------------------------------
    ...
    else
    {
      if( b_print_skipped )
      {
        std::cout << "Skipping beta-plus on " <<
                     Libnucnet__Species__getName( p_reactant ) << std::endl;
      }
    }
    ...
    else
    {
      if( b_print_skipped )
      {
        std::cout << "Skipping electron capture on " <<
                     Libnucnet__Species__getName( p_reactant ) << std::endl;
      }
    }
  ...
  //----------------------------------------------------------------------------
    ...
    if( p_reactant )
    {
      ...
      else
      {
        if( b_print_skipped )
        {
          std::cout << "Skipping beta minus on " <<
                       Libnucnet__Species__getName( p_reactant ) << std::endl;
        }
      }
      ...
      else
      {
        if( b_print_skipped )
        {
          std::cout << "Skipping positron capture on " <<
                       Libnucnet__Species__getName( p_reactant ) << std::endl;
        }
      }
    ...
    else
    {
      if( b_print_skipped )
      {
        std::cout << "Reactant with Z = " << i_z << " and A = " << i_a <<
